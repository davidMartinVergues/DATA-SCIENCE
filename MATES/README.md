...
Algunos ejemplos de números irracionales son ![formula](https://render.githubusercontent.com/render/math?math=\Large\sqrt{2}),![formula](https://render.githubusercontent.com/render/math?math=\Huge\pi), ![formula](https://render.githubusercontent.com/render/math?math=\Large\sqrt[3]{5}), donde por ejemplo ![formula](https://render.githubusercontent.com/render/math?math=\huge\pi) = 3.1415926535... proviene de la relación entre la longitud de una circunferencia y su diámetro. ![formula](https://render.githubusercontent.com/render/math?math=\Large\int_0^1xdx)
...
Un número imaginario es aquel <span style="font-size: 1.5rem;color:red">cuyo cuadrado es negativo.</span>
